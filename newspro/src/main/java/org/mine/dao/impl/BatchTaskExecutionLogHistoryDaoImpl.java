...
public class BatchTaskExecutionLogHistoryDaoImpl extends BaseDaoSupport implements BatchTaskExecutionLogHistoryDao {
	 ...
	 */
	@Override
	public BatchTaskExecutionLogHistory selectOne1(String historyTaskExecutionId, boolean nullException){
	 ...
	 */
	@Override
	public BatchTaskExecutionLogHistory selectOne1R(String historyTaskExecutionId, boolean nullException){
		Map<String, Object> map = new HashMap<String, Object>();
		map.put("historyTaskExecutionId", historyTaskExecutionId);
		BatchTaskExecutionLogHistory batchTaskExecutionLogHistory = new BatchTaskExecutionLogHistory();
	 ...
	 */
	@Override
	public BatchTaskExecutionLogHistory selectOne1L(String historyTaskExecutionId, boolean nullException){
		Map<String, Object> map = new HashMap<String, Object>();
		map.put("historyTaskExecutionId", historyTaskExecutionId);
		BatchTaskExecutionLogHistory batchTaskExecutionLogHistory = new BatchTaskExecutionLogHistory();
	 ...
	 */
	@Override
	public int deleteOne1(String historyTaskExecutionId){
		Map<String, Object> map = new HashMap<String, Object>();
		map.put("historyTaskExecutionId", historyTaskExecutionId);
	 ...
	 */
	@Override
	public int deleteOne1L(String historyTaskExecutionId){
		Map<String, Object> map = new HashMap<String, Object>();
		map.put("historyTaskExecutionId", historyTaskExecutionId);
	 ...
	 */
	@Override
	public void batchUpdate1(List<BatchTaskExecutionLogHistory> list){
		batchExcutor("BatchTaskExecutionLogHistory.batchUpdate1", list, "update", 20);
	}
	 ...
	 */
	@Override
	public void batchUpdateXML(List<BatchTaskExecutionLogHistory> list){
		BatchInsertByXML(list, "list", 20, new BatchOperator<Integer, Map<String, Object>>() {
			@Override
			public Integer call(Map<String, Object> map) {
				return getSqlSessionTemplate().update("BatchTaskExecutionLogHistory.batchUpdateXML", map);
			};
		});
	}
