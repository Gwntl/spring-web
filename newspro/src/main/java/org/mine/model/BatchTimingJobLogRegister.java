...
/**
 * batch_timing_job_log_register--批量定时任务日志登记表
 * @filename BatchTimingJobLogRegister.java
 * @author wzaUsers
 * @date 2020-08-20 11:08:58
 * @version v1.0
*/
public class BatchTimingJobLogRegister {
	/**
	 * 任务执行ID
	 */
	...
	public BatchTimingJobLogRegister() {
		this.executionId = "";
